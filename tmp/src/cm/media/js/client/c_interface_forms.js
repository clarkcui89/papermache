...
gFormHtml = {
    ...
    'urlInput'    :gettext("URL:") + '<center><input id="###" name="url" class="n_url comment_input" style="padding:1px;" type="text"></input></center>',
...
getHtml = function(ids) {
  ...
  html = html + gFormHtml['urlInput'].replace('###', ids['urlInputId']) ;
