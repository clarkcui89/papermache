...
gConf = {'iCommentLeftPadding':4, 
    'iCommentThreadPadding':12,
        ...
        'defaultPrefs':{
          'text':{'style':'text-modern-style'},
          'user' : {'name' : '','email' : ''},
          'general': {'animduration' : '0.4'},
          'comments': {'threadpad' : '1'},
          'layout': {'comments_col_width' : '25', 'right_col_width' : '25'  /* out of 100 */}}
};
...
onDomReady = function(arg1) {
  ...
  q1.add( {
    ...
    fn : function() {
      ...
      val = (sv_withComments) ? gPrefs.get('layout','right_col_width') : 0 ; 
      colWidth = sliderValToPx(val) ;
      gLayout.setRightColumnWidth(colWidth) ;
      ...
      if (gLayout.isInFrame()) {
        ...
        if (sv_withComments) {
          ...
          if (hasPerm("can_create_comment"))    
            ...
            parent.$("#view_text_info_btn").removeClass('initially_hidden');
