...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Text.last_text_version'
        db.alter_column('cm_text', 'last_text_version_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['cm.TextVersion']))
        # Adding field 'Comment.url'
        db.add_column('cm_comment', 'url',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Text.last_text_version'
        db.alter_column('cm_text', 'last_text_version_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cm.TextVersion']))
        # Deleting field 'Comment.url'
        db.delete_column('cm_comment', 'url')


        # Changing field 'Attachment.text_version'
        db.alter_column('cm_attachment', 'text_version_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['cm.TextVersion']))
    ...
    models = {
        ...
        'cm.attachment': {
            ...
            'text_version': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cm.TextVersion']", 'null': 'True'})
        },
        'cm.comment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_key': ('django.db.models.fields.CharField', [], {'default': "'bn7R5fiMNiT'", 'max_length': '20', 'db_index': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
        ...
        'cm.text': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20', 'db_index': 'True'}),
            'last_text_version': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'related_text'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['cm.TextVersion']"}),
